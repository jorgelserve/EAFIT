...
var _templateObject = _taggedTemplateLiteral(['<div>\n\t\t<h2>Bienvenido ', '</h2> <button class="btn waves-effect waves-light logout" onclick=', '>Cerrar sesi\xF3n</button>\n\t\t<br><br>\n\t\t<div class="row">\n\t\t\t<div class="div col s8 offset-s2">\n\t\t\t\t<div class="progress">\n\t\t\t\t\t<div class="determinate" style="width: 70%"></div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\n\n\n\t</div>'], ['<div>\n\t\t<h2>Bienvenido ', '</h2> <button class="btn waves-effect waves-light logout" onclick=', '>Cerrar sesi\xF3n</button>\n\t\t<br><br>\n\t\t<div class="row">\n\t\t\t<div class="div col s8 offset-s2">\n\t\t\t\t<div class="progress">\n\t\t\t\t\t<div class="determinate" style="width: 70%"></div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\n\n\n\t</div>']);
...
page('/bienvenido', verificarUsuario, function (ctx, next) {
	...
	empty(container).appendChild(yo(_templateObject, ctx.user.email, logout));
